  ...
  return (
    <Card className="col-span-full border-2 border-kit-teal/40 bg-card shadow-card">
      <CardHeader className="pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <CardDescription className="text-kit-tealDeep">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-background rounded-lg p-4 border border-kit-teal/40">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-kit-tealDeep space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-kit-tealDeep">
                <li><code className="bg-kit-teal/20 px-1 rounded">base</code> - Área principal (Cacao, Educación, Formare, etc.)</li>
                <li><code className="bg-kit-teal/20 px-1 rounded">seccion</code> - Subsección (The Cacao Effect, Generación R, Educación, Formare)</li>
                <li><code className="bg-kit-teal/20 px-1 rounded">programa</code> - Nombre del programa específico</li>
                <li><code className="bg-kit-teal/20 px-1 rounded">departamento</code> - Departamento o región</li>
                <li><code className="bg-kit-teal/20 px-1 rounded">cod_entidad</code> - (Opcional) Código de la entidad</li>
                <li><code className="bg-kit-teal/20 px-1 rounded">entidad</code> - (Opcional) Nombre del municipio/entidad</li>
                <li><code className="bg-kit-teal/20 px-1 rounded">valor</code> - Número de participantes</li>
                <li><code className="bg-kit-teal/20 px-1 rounded">year</code> - Año de los datos</li>
                <li><code className="bg-kit-teal/20 px-1 rounded">categoria</code> - (Opcional) Categoría adicional</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            {isUploading ? (
              <div className="flex flex-col items-center gap-4 w-full">
                <div className="relative">
                  <Loader2 className="h-12 w-12 animate-spin text-kit-tealDeep" />
                </div>
                <div className="w-full max-w-md space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <p className="font-medium text-kit-tealDeep truncate flex-1">
                      {fileName || "Procesando..."}
                    </p>
                    <p className="text-kit-tealDeep ml-2 font-bold">
                      {Math.round(progress)}%
                    </p>
                  </div>
                  <Progress value={progress} className="h-2" />
                  <p className="text-xs text-kit-tealDeep">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="p-4 rounded-full bg-kit-teal/20">
                  <Upload className="h-10 w-10 text-kit-tealDeep" />
                </div>
                <div>
                  <p className="text-lg font-semibold text-kit-tealDeep">
                    Arrastra o haz clic para subir
                  </p>
                  <p className="text-sm text-kit-tealDeep mt-1">
                    Archivo Excel (.xlsx) con datos de participantes
                  </p>
                </div>
                <div className="flex items-center gap-2 text-xs text-kit-tealDeep">
        ...
        {/* Note */}
        <p className="text-xs text-kit-tealDeep text-center">
