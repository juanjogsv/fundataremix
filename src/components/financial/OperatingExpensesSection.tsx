    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Cargando datos de funcionamiento...</p>
        </div>
      </div>
    );
  }
                  ...
                  {filteredData.length === 0 ? (
                    ...
                    filteredData.map((expense) => {
                      ...
                      return (
                        ...
                        >
                          <TableCell className={expense.is_parent ? 'font-bold text-luker-brown text-base' : 'pl-8 text-foreground/85'}>
                            {expense.item_name}
                          </TableCell>
