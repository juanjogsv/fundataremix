...
const EducationPreschoolRanking = () => {
  ...
  useEffect(() => {
    const loadYears = async () => {
      try {
        ...
        // Seleccionar el último año por defecto
        if (years.length > 0) {
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            ...
            <CardTitle className="text-xl text-luker-brown">
              Ranking de Entidades: Cobertura Neta en Preescolar
            </CardTitle>
          </div>
...
export default EducationPreschoolRanking;
