...
const KPI_CONFIG: Array<{
  ...
  { code: "COBE_02", title: "Cobertura Neta Preescolar", icon: School,        bg: "bg-rose-50",   iconBg: "bg-rose-100",   text: "text-rose-600" },
  { code: "COBE_03", title: "Cobertura Neta Primaria",   icon: BookOpen,      bg: "bg-amber-50",  iconBg: "bg-amber-100",  text: "text-amber-600" },
  { code: "COBE_04", title: "Cobertura Neta Secundaria", icon: GraduationCap, bg: "bg-green-50",  iconBg: "bg-green-100",  text: "text-green-600" },
  { code: "COBE_01", title: "Cobertura Neta Media",      icon: Users,         bg: "bg-sky-50",    iconBg: "bg-sky-100",    text: "text-sky-600" },
